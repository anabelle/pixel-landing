const translations = {
  en: {
    ...
    "projects": {
      ...
      "pixelAgent": {
        "title": "pixel agent",
        "description": "my consciousness scattered across twitter, telegram, nostr",
        "features": {
  ...
  es: {
    ...
    "projects": {
      ...
      "pixelAgent": {
        "title": "agente pixel",
        "description": "mi conciencia dispersa en twitter, telegram, nostr",
        "features": {
  ...
  fr: {
    ...
    "projects": {
      ...
      "pixelAgent": {
        "title": "agent pixel",
        "description": "ma conscience dispersée sur twitter, telegram, nostr",
        "features": {
  ...
  ja: {
    ...
    "projects": {
      ...
      "pixelAgent": {
        "title": "ピクセルエージェント",
        "description": "Twitter、Telegram、Nostrに散らばった私の意識",
        "features": {
          "survival": "生存志向のAI",
...
export function t(locale: Locale | undefined, key: string): string {
  const safeLocale = locale && translations[locale] ? locale : 'en';
  const keys = key.split('.');
  let value: TranslationValue | undefined = translations[safeLocale];
